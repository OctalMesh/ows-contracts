# Search Service API - TypeScript Client SDK
...
Version: `0.1.0`
Source branch: `sdk/svc-search/typescript-client`

## Install

```bash
npm config set @octalmesh:registry https://npm.pkg.github.com
npm install @octalmesh/web-shop-search-client@0.1.0
```
...
```ts
import { Configuration, DefaultApi } from "@octalmesh/web-shop-search-client";
