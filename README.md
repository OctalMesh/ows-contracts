# Catalog Service API - TypeScript Client SDK
...
Version: `0.1.0`
Source branch: `sdk/svc-catalog/typescript-client`

## Install

```bash
npm config set @octalmesh:registry https://npm.pkg.github.com
npm install @octalmesh/web-shop-catalog-client@0.1.0
```
...
```ts
import { Configuration, DefaultApi } from "@octalmesh/web-shop-catalog-client";
