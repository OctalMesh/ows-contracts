# Payment Service API - TypeScript Client SDK
...
Version: `0.1.0`
Source branch: `sdk/svc-payment/typescript-client`

## Install

```bash
npm config set @octalmesh:registry https://npm.pkg.github.com
npm install @octalmesh/web-shop-payment-client@0.1.0
```
...
```ts
import { Configuration, DefaultApi } from "@octalmesh/web-shop-payment-client";
